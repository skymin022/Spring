 ...
 *  🟡 Restful 웹 서버를 생성하는데 생성
 *  🟡 @Controller와 @ResponseBody를 합한 역할을 하는 어노테이션 
 *  ✅ @Controller          ➡ View를 반환
 *  ✅ @RestController      ➡ 응답 데이터(메시지[상태코드, 응답헤더, 응답 본문(body)])를 반환 
 */
@Slf4j
@RestController
public class ResponseController {
    ...
    public List<Board> collectionResponse() {
        ...
        boardList.add(new Board(2,"제목1", "작성자1", "내용1"));
        boardList.add(new Board(3, "제목2", "작성자2", "내용2"));
        boardList.add(new Board(4,"제목3", "작성자3", "내용3"));
        return boardList;
    }
    ...
    public Map<String, ?> mapResponse() {
        ...
        map.put("board", new Board(5,"제목", "작성자", "내용"));
